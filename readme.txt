1. Install latest LTS Nodejs from https://nodejs.org/en/download/
2. Issue the following command to verify the version
>node -version
...
>npm start
8. Open browser and visit http://127.0.0.1:8081 to view the Glarimy Quiz Community homepage
